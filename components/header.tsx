...
import { faSearch, faCog, faSliders } from '@fortawesome/free-solid-svg-icons';
            ...
            <div className="flex-grow mx-10 flex">
                <div className="flex-grow mx-10 flex items-center justify-start bg-gray-950">
                    <div className="relative w-1/3">
                        ...
                        />
                        <FontAwesomeIcon icon={faSliders} className="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400" />
                    </div>
                </div>
            </div>
